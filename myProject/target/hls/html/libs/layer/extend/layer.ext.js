...
layer.use('skin/layer.ext.css', function(){
    ...
    layer.showMsg = function(msg,type,callback){
    	var icon;
    	var title = '';
    	...
    	return layer.alert(msg,icon,title,callback);
    };
    
    layer.showConfirm = function(msg,success,faile){
         var successCallback = function(index){
	   		 if(typeof(success) == 'function'){
	   			 success();
	   		 }
	   		 layer.close(index);
	   	 };
	   	 var faileCallBack = function(index){
